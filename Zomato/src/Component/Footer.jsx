      ...
      <footer class="bg-gray-900">
        <div class="max-w-5xl px-4 py-16 mx-auto sm:px-6 lg:px-8">
          ...
          <p class="max-w-md mx-auto mt-6 leading-relaxed text-center text-gray-400">
            Deeksha-da-dhaba you can visit here and order your food be healthy
            be safe
          </p>
          ...
          <nav class="mt-12" aria-labelledby="footer-navigation">
            ...
            <ul class="flex flex-wrap justify-center gap-6 md:gap-8 lg:gap-12">
              <li>
                <a class="text-white transition hover:text-white/75">About</a>
              </li>

              <li>
                <a class="text-white transition hover:text-white/75">Careers</a>
              </li>

              <li>
                <a class="text-white transition hover:text-white/75">History</a>
              </li>
              ...
              <li>
                <a class="text-white transition hover:text-white/75">Blog</a>
              </li>
            </ul>
          </nav>
